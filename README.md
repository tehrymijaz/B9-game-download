...
<head>
  ...
  <style>
    :root{--bg:#060612;--card:#0d1020;--muted:#9aa4b2;--accent1:#00eaff;--accent2:#7a00ff;--glass:rgba(255,255,255,0.03);--radius:14px}
    *{box-sizing:border-box}
    body{margin:0; font-family:Inter, system-ui, -apple-system, 'Segoe UI', Roboto, Arial; background:linear-gradient(180deg,#03030a 0%, #071026 100%); color:#e8f1ff; line-height:1.6}
    .wrap{max-width:1100px; margin:30px auto; padding:24px}
    header.site-head{display:flex; gap:20px; align-items:center; background:linear-gradient(135deg, rgba(122,0,255,0.06), rgba(0,234,255,0.04)); padding:22px; border-radius:16px}
    .logo{width:84px;height:84px;border-radius:14px;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:20px;background:linear-gradient(135deg,var(--accent1),var(--accent2));color:#021025}
    .head-text h1{margin:0;font-size:22px}
    .kicker{font-size:12px;color:var(--muted);text-transform:uppercase;letter-spacing:1px}
    .lead{margin-top:8px;color:#d7e6fb}

    .layout{display:grid; grid-template-columns:1fr 340px; gap:20px; margin-top:22px}
    ...
    h2{font-size:18px;margin:0 0 10px 0; background:linear-gradient(90deg,var(--accent1),var(--accent2)); -webkit-background-clip:text; -webkit-text-fill-color:transparent}
    .muted{color:var(--muted);font-size:14px}
    p{margin:0 0 12px 0}

    .features{display:grid; grid-template-columns:repeat(2,1fr); gap:12px}
    .feature{background:linear-gradient(135deg, rgba(255,255,255,0.01), rgba(122,0,255,0.02)); padding:14px; border-radius:12px; border:1px solid rgba(255,255,255,0.03)}
    ...
    .btn-primary{background:linear-gradient(90deg,var(--accent1),var(--accent2)); color:#021025; box-shadow:0 6px 20px rgba(122,0,255,0.12)}
    .btn-ghost{background:transparent;color:var(--muted);border:1px solid rgba(255,255,255,0.04)}

    .screens{display:grid; grid-template-columns:repeat(3,1fr); gap:12px; margin-top:10px}
    .screenshot{min-height:120px;border-radius:10px;background:linear-gradient(135deg,#121126,#0b0f1c);display:flex;align-items:center;justify-content:center;color:var(--accent1);font-weight:700;letter-spacing:1px;box-shadow:0 8px 30px rgba(0,234,255,0.06);border:1px solid rgba(0,234,255,0.04)}
    ...
    @media(max-width:980px){.layout{grid-template-columns:1fr}.screens{grid-template-columns:repeat(2,1fr)}.logo{width:64px;height:64px}}
  </style>
</head>
<body>
  <div class="wrap">
